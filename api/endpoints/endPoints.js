export const postProductNote_endpoint = "/api/admin/add-product-note";
export const getProductNote_endpoint = "/api/admin/get-product-notes";

export const getOrderNote_endpoint = "/api/admin/get-order-notes";
export const postOrderNote_endpoint = "/api/admin/add-order-note";

export const getVendorNote_endpoint = "/api/admin/get-vendor-notes";
export const postVendorNote_endpoint = "/api/admin/add-vendor-note";

export const getBrandNote_endpoint = "/api/admin/get-brand-notes";
export const postBrandNote_endpoint = "/api/admin/add-brand-note";
