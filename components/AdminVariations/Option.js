...
function Option({ option, refetch }) {
    ...
    if (
      ...
      return;
        ...
        if(newArName.current.value.trim() != ""){
            editData.value_ar  = newArName.current.value ;
        }
...
//   }
  ...
  return (
    <>
      ...
      >
        <td className="px-4 py-4">{option.id}</td>
        <td className="px-4 py-4">{option.attribute_name}</td>
        <td className="px-4 py-4">{option.value_en}</td>
        <td className="px-4 py-4">{option.value_ar}</td>
        <td class="px-4 py-4">
      ...
      >
        <DialogTitle className="flex justify-between border-b-2 border-black">
          <h4 className="text-gray-500 md:pl-6 font-medium">
            Edit Option of Variation : {option.attribute_name}
          </h4>
        </DialogTitle>
        <DialogContent>
